...
//     // এখানে তুমি API call করবে later
//   };
...
//               </label>
//               <label className="flex items-center">
//                 <input type="radio" value="Female" {...register("gender", { required: "Gender is required" })} className="mr-2" /> Female
//               </label>
//               <label className="flex items-center">
//                 <input type="radio" value="Other" {...register("gender", { required: "Gender is required" })} className="mr-2" /> Other
//               </label>
//             </div>
